...
class App extends Component {
  ...
  render(){
    ...
    const { userEmail, userRole, role, group, day, getGlobalDay, setGlobalDay, creationDate } = this.props;
    ...
    console.log(`****  App  render  creationDate:  ${ JSON.stringify(creationDate) }`);
